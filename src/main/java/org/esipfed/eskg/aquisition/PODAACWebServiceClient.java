 ...
 * href="https://podaac.jpl.nasa.gov/ws">NASA JPL PO.DAAC WebServices</a>. This
 * client enables us to GET Dataset metadata using the following parameters:
 * <i>dataset_id</i>, <i>short_name</i>, and <i>format</i>.
 * 
 * @author lewismc
 */
public class PODAACWebServiceClient {
     ...
     * 'q' parameter to wildcard and increase the 'itemsPerPage' to more than
     * the number of Datasets we know to be present within PO.DAAC. This ensure
     * we get all Datasets within our search results.
     */
    ...
    /**
     * Core function which encapsulates all data acquisition and model mapping
     * for PO.DAAC Dataset Search and Dataset Metadata WebServices.
     * 
     * @throws IOException
     */
     ...
     * extract all instances of 'podaac:datasetId' and add these to an
     * ArrayList. We use this List to obtain GMCD Metadata for each dataset.
     * 
