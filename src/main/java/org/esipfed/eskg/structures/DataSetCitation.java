...
@XmlType(name = "", propOrder = { "datasetCreator", "datasetTitle", "datasetSeriesName", "datasetReleaseDate", "datasetReleasePlace", "datasetPublisher", "version", "issueIdentification",
        "dataPresentationForm", "otherCitationDetails", "onlineResource" })
