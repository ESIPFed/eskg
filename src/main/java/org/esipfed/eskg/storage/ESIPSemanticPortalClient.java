...
//
//public class ESIPSemanticPortalClient implements StorageClient {
//
//  private static final Logger LOG = LoggerFactory.getLogger(ESIPSemanticPortalClient.class);
//
//  private static final String REST_URL = "http://semanticportal.esipfed.org:8080";
//  private static final String API_KEY = "59f9f403-51f3-417e-9294-f9be7a737f50";
//  private static final String AUTH = "Authorization";
//  private static final String API_TOKEN = "apikey token=";
//  private static final String ACCEPT = "Accept";
//  private static final String APP_JSON = "application/json";
//
//  private ESIPSemanticPortalClient(){}
//
...
//      conn.setRequestProperty(AUTH, API_TOKEN + API_KEY);
...
//
//  // post text file
//  public static void write(OntModel ontModel, Properties props) {
//    URL url;
//    HttpURLConnection conn;
//
...
//              + "filename=\"" + ontologyFile.getName() + "\"").append(crlf);
...
//    String getResponse = ESIPSemanticPortalClient.get(REST_URL + "/ontologies/GCMD-DIF/submissions");
...
//    ESIPSemanticPortalClient.write(
